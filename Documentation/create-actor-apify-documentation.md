---
title: Create Actor | Apify Documentation
source: https://docs.apify.com/api/v2/acts-post
---

[Skip to main content](https://docs.apify.com/api/v2/acts-post#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/ActorCollectionClient#create) [![Python](https://docs.apify.com/img/python-40x40.svg)Python](https://docs.apify.com/api/client/python/reference/class/ActorCollectionClientAsync#create)
...
[Get Actor](https://docs.apify.com/api/v2/acts-post#/reference/actors/actor-object/get-actor) endpoint.
...
For more information, see [Version object](https://docs.apify.com/api/v2/acts-post#/reference/actors/version-object).
...
## Request [Direct link to request](https://docs.apify.com/api/v2/acts-post\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/acts-post\#responses)
...
-d '{
  ...
  "versions": "Unknown Type: array,null",
  "pricingInfos": [\
    {\
