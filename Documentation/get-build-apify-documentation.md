---
title: Get build | Apify Documentation
source: https://docs.apify.com/api/v2/act-build-get
---

[Skip to main content](https://docs.apify.com/api/v2/act-build-get#__docusaurus_skipToContent_fallback)
...
API endpoints related to build of the Actor were moved under new namespace [`actor-builds`](https://docs.apify.com/api/v2/act-build-get#/reference/actor-builds). Gets an object that contains all the details about a specific build of an Actor.
...
## Request [Direct link to request](https://docs.apify.com/api/v2/act-build-get\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/act-build-get\#responses)
...
```bash
curl -L 'https://api.apify.com/v2/acts/:actorId/builds/:buildId' \
