---
title: Delete task | Apify Documentation
source: https://docs.apify.com/api/v2/actor-task-delete
---

[Skip to main content](https://docs.apify.com/api/v2/actor-task-delete#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/TaskClient#delete)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/actor-task-delete\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/actor-task-delete\#responses)
