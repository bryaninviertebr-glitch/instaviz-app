---
title: Run Actor | Apify Documentation
source: https://docs.apify.com/api/v2/act-runs-post
---

[Skip to main content](https://docs.apify.com/api/v2/act-runs-post#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/ActorClient#start) [![Python](https://docs.apify.com/img/python-40x40.svg)Python](https://docs.apify.com/api/client/python/reference/class/ActorClientAsync#call)
...
run](https://docs.apify.com/api/v2/act-runs-post#/reference/actor-runs/run-object-and-its-storages/get-run) API
endpoint.
...
synchronously](https://docs.apify.com/api/v2/act-runs-post#/reference/actors/run-actor-synchronously) API endpoints
instead.
...
received in the response JSON to the [Get dataset items](https://docs.apify.com/api/v2/act-runs-post#/reference/datasets/item-collection/get-items)
API endpoint.

## Request [Direct link to request](https://docs.apify.com/api/v2/act-runs-post\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/act-runs-post\#responses)
...
```bash
curl -L 'https://api.apify.com/v2/acts/:actorId/runs' \
...
forcePermissionLevel — query

\-\-\-LIMITED\_PERMISSIONSFULL\_PERMISSIONS
