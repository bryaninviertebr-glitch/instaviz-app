---
title: Reboot run | Apify Documentation
source: https://docs.apify.com/api/v2/actor-run-reboot-post
---

[Skip to main content](https://docs.apify.com/api/v2/actor-run-reboot-post#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/RunClient#reboot) [![Python](https://docs.apify.com/img/python-40x40.svg)Python](https://docs.apify.com/api/client/python/reference/class/RunClientAsync#reboot)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/actor-run-reboot-post\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/actor-run-reboot-post\#responses)
...
```bash
curl -L -X POST 'https://api.apify.com/v2/actor-runs/:runId/reboot' \
