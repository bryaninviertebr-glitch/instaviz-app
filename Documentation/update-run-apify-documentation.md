---
title: Update run | Apify Documentation
source: https://docs.apify.com/api/v2/actor-run-put
---

[Skip to main content](https://docs.apify.com/api/v2/actor-run-put#__docusaurus_skipToContent_fallback)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/actor-run-put\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/actor-run-put\#responses)
