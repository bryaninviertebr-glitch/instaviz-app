---
title: Get last run | Apify Documentation
source: https://docs.apify.com/api/v2/act-runs-last-get
---

[Skip to main content](https://docs.apify.com/api/v2/act-runs-last-get#__docusaurus_skipToContent_fallback)
...
are the same as in the [Run object](https://docs.apify.com/api/v2/act-runs-last-get#/reference/actors/run-object) endpoint.
...
[Key-value store object](https://docs.apify.com/api/v2/act-runs-last-get#/reference/key-value-stores/store-object) endpoint.

Additionally, each of the above API endpoints supports all sub-endpoints
of the original one:

#### Key-value store [Direct link to Key-value store](https://docs.apify.com/api/v2/act-runs-last-get\#key-value-store)

- `/v2/acts/{actorId}/runs/last/key-value-store/keys{?token,status}` [Key collection](https://docs.apify.com/api/v2/act-runs-last-get#/reference/key-value-stores/key-collection)
- `/v2/acts/{actorId}/runs/last/key-value-store/records/{recordKey}{?token,status}` [Record](https://docs.apify.com/api/v2/act-runs-last-get#/reference/key-value-stores/record)

#### Dataset [Direct link to Dataset](https://docs.apify.com/api/v2/act-runs-last-get\#dataset)

- `/v2/acts/{actorId}/runs/last/dataset/items{?token,status}` [Item collection](https://docs.apify.com/api/v2/act-runs-last-get#/reference/datasets/item-collection)

#### Request queue [Direct link to Request queue](https://docs.apify.com/api/v2/act-runs-last-get\#request-queue)

- `/v2/acts/{actorId}/runs/last/request-queue/requests{?token,status}` [Request collection](https://docs.apify.com/api/v2/act-runs-last-get#/reference/request-queues/request-collection)
- `/v2/acts/{actorId}/runs/last/request-queue/requests/{requestId}{?token,status}` [Request collection](https://docs.apify.com/api/v2/act-runs-last-get#/reference/request-queues/request)
- `/v2/acts/{actorId}/runs/last/request-queue/head{?token,status}` [Queue head](https://docs.apify.com/api/v2/act-runs-last-get#/reference/request-queues/queue-head)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/act-runs-last-get\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/act-runs-last-get\#responses)
...
```bash
curl -L 'https://api.apify.com/v2/acts/:actorId/runs/last' \
