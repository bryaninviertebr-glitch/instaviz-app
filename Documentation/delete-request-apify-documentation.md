---
title: Delete request | Apify Documentation
source: https://docs.apify.com/api/v2/request-queue-request-delete
---

[Skip to main content](https://docs.apify.com/api/v2/request-queue-request-delete#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/RequestQueueClient#delete)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/request-queue-request-delete\#request)
...
head](https://docs.apify.com/api/v2/request-queue-request-delete#/reference/request-queues/queue-head) operation.

**Example:** `client-abc`

## Responses [Direct link to Responses](https://docs.apify.com/api/v2/request-queue-request-delete\#responses)
...
```bash
curl -L -X DELETE 'https://api.apify.com/v2/request-queues/:queueId/requests/:requestId' \
