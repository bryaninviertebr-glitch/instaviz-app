---
title: Delete request lock | Apify Documentation
source: https://docs.apify.com/api/v2/request-queue-request-lock-delete
---

[Skip to main content](https://docs.apify.com/api/v2/request-queue-request-lock-delete#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/RequestQueueClient#deleteRequestLock) [![Python](https://docs.apify.com/img/python-40x40.svg)Python](https://docs.apify.com/api/client/python/reference/class/RequestQueueClientAsync#delete_request_lock)
...
operation](https://docs.apify.com/api/v2/request-queue-request-lock-delete#/reference/request-queues/queue-head-with-locks).

## Request [Direct link to request](https://docs.apify.com/api/v2/request-queue-request-lock-delete\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/request-queue-request-lock-delete\#responses)
...
```bash
curl -L -X DELETE 'https://api.apify.com/v2/request-queues/:queueId/requests/:requestId/lock' \
