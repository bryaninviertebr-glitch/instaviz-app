---
title: Update request queue | Apify Documentation
source: https://docs.apify.com/api/v2/request-queue-put
---

[Skip to main content](https://docs.apify.com/api/v2/request-queue-put#__docusaurus_skipToContent_fallback)
...
[Get request queue](https://docs.apify.com/api/v2/request-queue-put#/reference/request-queues/queue-collection/get-request-queue) API endpoint.

## Request [Direct link to request](https://docs.apify.com/api/v2/request-queue-put\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/request-queue-put\#responses)
...
```bash
curl -L -X PUT 'https://api.apify.com/v2/request-queues/:queueId' \
