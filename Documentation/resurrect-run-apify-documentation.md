---
title: Resurrect run | Apify Documentation
source: https://docs.apify.com/api/v2/act-run-resurrect-post
---

[Skip to main content](https://docs.apify.com/api/v2/act-run-resurrect-post#__docusaurus_skipToContent_fallback)
...
new namespace [`actor-runs`](https://docs.apify.com/api/v2/act-run-resurrect-post#/reference/actor-runs).Resurrects a finished
...
## Request [Direct link to request](https://docs.apify.com/api/v2/act-run-resurrect-post\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/act-run-resurrect-post\#responses)
...
```bash
curl -L -X POST 'https://api.apify.com/v2/acts/:actorId/runs/:runId/resurrect' \
