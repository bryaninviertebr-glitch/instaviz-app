---
title: Get request queue | Apify Documentation
source: https://docs.apify.com/api/v2/request-queue-get
---

[Skip to main content](https://docs.apify.com/api/v2/request-queue-get#__docusaurus_skipToContent_fallback)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/request-queue-get\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/request-queue-get\#responses)
...
```bash
curl -L 'https://api.apify.com/v2/request-queues/:queueId' \
