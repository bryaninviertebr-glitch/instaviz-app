---
title: Metamorph run | Apify Documentation
source: https://docs.apify.com/api/v2/act-run-metamorph-post
---

[Skip to main content](https://docs.apify.com/api/v2/act-run-metamorph-post#__docusaurus_skipToContent_fallback)
...
new namespace [`actor-runs`](https://docs.apify.com/api/v2/act-run-metamorph-post#/reference/actor-runs).Transforms an Actor run
...
## Request [Direct link to request](https://docs.apify.com/api/v2/act-run-metamorph-post\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/act-run-metamorph-post\#responses)
...
```bash
curl -L -X POST 'https://api.apify.com/v2/acts/:actorId/runs/:runId/metamorph' \
