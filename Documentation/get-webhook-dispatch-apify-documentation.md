---
title: Get webhook dispatch | Apify Documentation
source: https://docs.apify.com/api/v2/webhook-dispatch-get
---

[Skip to main content](https://docs.apify.com/api/v2/webhook-dispatch-get#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/WebhookDispatchClient#get) [![Python](https://docs.apify.com/img/python-40x40.svg)Python](https://docs.apify.com/api/client/python/reference/class/WebhookDispatchClientAsync#get)
...
## Request [Direct link to request](https://docs.apify.com/api/v2/webhook-dispatch-get\#request)

### Path Parameters

**dispatchId** stringrequired

Webhook dispatch ID.

**Example:** `Zib4xbZsmvZeK55ua`

## Responses [Direct link to Responses](https://docs.apify.com/api/v2/webhook-dispatch-get\#responses)
...
```bash
curl -L 'https://api.apify.com/v2/webhook-dispatches/:dispatchId' \
