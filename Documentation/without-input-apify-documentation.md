---
title: Without input | Apify Documentation
source: https://docs.apify.com/api/v2/act-run-sync-get
---

[Skip to main content](https://docs.apify.com/api/v2/act-run-sync-get#__docusaurus_skipToContent_fallback)
...
Actor](https://docs.apify.com/api/v2/act-run-sync-get#/reference/actors/run-collection/run-actor) API endpoint instead.

## Request [Direct link to request](https://docs.apify.com/api/v2/act-run-sync-get\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/act-run-sync-get\#responses)
