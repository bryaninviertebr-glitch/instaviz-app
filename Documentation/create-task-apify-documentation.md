---
title: Create task | Apify Documentation
source: https://docs.apify.com/api/v2/actor-tasks-post
---

[Skip to main content](https://docs.apify.com/api/v2/actor-tasks-post#__docusaurus_skipToContent_fallback)

API Clients

[![JavaScript](https://docs.apify.com/img/javascript-40x40.svg)JavaScript](https://docs.apify.com/api/client/js/reference/class/TaskCollectionClient#create) [![Python](https://docs.apify.com/img/python-40x40.svg)Python](https://docs.apify.com/api/client/python/reference/class/TaskCollectionClientAsync#create)
...
[Get task](https://docs.apify.com/api/v2/actor-tasks-post#/reference/tasks/task-object/get-task) endpoint.

The request needs to specify the `Content-Type: application/json` HTTP header!

When providing your API authentication token, we recommend using the
request's `Authorization` header, rather than the URL. ( [More\\
info](https://docs.apify.com/api/v2/actor-tasks-post#/introduction/authentication)).

## Request [Direct link to request](https://docs.apify.com/api/v2/actor-tasks-post\#request)
...
## Responses [Direct link to Responses](https://docs.apify.com/api/v2/actor-tasks-post\#responses)
